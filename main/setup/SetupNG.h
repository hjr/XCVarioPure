...
enum e_display_variant { DISPLAY_WHITE_ON_BLACK, DISPLAY_BLACK_ON_WHITE };
...
enum e_xcvrole { NO_ROLE, MASTER_ROLE, SECOND_ROLE }; // do not remove NO_ROLE, or change the order. Device nvs store is based on this bitorder.
...
extern SetupNG<dps_t>       gyro_gating;
...
extern SetupNG<gee_t>		gload_pos_limit_low;
extern SetupNG<gee_t>		gload_neg_limit_low;
extern SetupNG<gee_t>		gload_pos_limit;
extern SetupNG<gee_t>		gload_neg_limit;
extern SetupNG<gee_t>		gload_pos_max;
extern SetupNG<gee_t>		gload_neg_max;
extern SetupNG<mps_t>		airspeed_max;
