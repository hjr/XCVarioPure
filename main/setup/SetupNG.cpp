...
SetupNG<int>  			normal_setup( "FACTMENU" , 0, false, SYNC_NONE, PERSISTENT, nullptr, quantity_t::QUANT_NONE, nullptr, true ); // 0: factory factory menu 1: normal setup menu
...
SetupNG<t_tenchar_id>  	ota_ap( "OTA_AP",  t_tenchar_id(""), false );
...
SetupNG<gee_t>			gload_pos_limit_low("GLOADPLL", 3, true, SYNC_NONE, PERSISTENT, nullptr, quantity_t::QUANT_NONE, &pos_g_limits);
SetupNG<gee_t>			gload_neg_limit_low("GLOADNLL", -2, true, SYNC_NONE, PERSISTENT, nullptr, quantity_t::QUANT_NONE, &neg_g_limits);
SetupNG<gee_t>			gload_pos_limit("GLOADPL", 5, true, SYNC_NONE, PERSISTENT, nullptr, quantity_t::QUANT_NONE, &pos_g_limits);
SetupNG<gee_t>			gload_neg_limit("GLOADNL", -3, true, SYNC_NONE, PERSISTENT, nullptr, quantity_t::QUANT_NONE, &neg_g_limits);
SetupNG<gee_t>			gload_pos_max("GLOADPM", 1, false);
SetupNG<gee_t>			gload_neg_max("GLOADNM", 0, false);
SetupNG<mps_t>			airspeed_max("ASMAX", 0 , false, SYNC_NONE, PERSISTENT, nullptr, quantity_t::QUANT_HSPEED);
